...
import { createPermissionDirective } from '@time-machine-lab/tml-ui'
...
```ts
import { createPermissionDirective, DEFAULT_PERMISSION_REPLACE_ATTR } from '@time-machine-lab/tml-ui'
