...
// 组件实例类型
import type { TmlRow, TmlCol } from '@time-machine-lab/tml-ui'
```
...
import { TmlRow, TmlCol } from '@time-machine-lab/tml-ui'
import type { RowProps, ColProps } from '@time-machine-lab/tml-ui'
